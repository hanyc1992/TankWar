...
public class TankClient extends Frame{
	...
	public static final int ADD_AID_MAX = 20000;
	public static final int ADD_AID_MIN = 8000;
	...
	private void updateAllPaceEnenmy() {
		for (int i = 0; i < arrEnenmy.size(); ++i)
				arrEnenmy.get(i).updatePaceEnenmy();
	}
