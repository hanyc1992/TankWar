...
public static final int ROLL_MAX = 15;
	...
	public static final int MEDIUM = 85;
	public static final int HARD = 78;
	public static final int CRAZY = 60;
	
	public static final int TANK_RADIUS = 50;
	
	public static final int ENENY_LIFE_INIT = 50;
	...
	public static final int PACE_EASY = 2;
	public static final int PACE_MIDIUM = 3;
	public static final int PACE_HARD = 4;
	public static final int PACE_CRAZY = 6;
	int PACE_ENENMY = (TankClient.MODE==EASY)?PACE_EASY:(TankClient.MODE==MEDIUM)?PACE_MIDIUM:(TankClient.MODE==HARD)?PACE_HARD:PACE_CRAZY;
	int PACE_MY = 4;
	
	public void updatePaceEnenmy() {
		PACE_ENENMY = (TankClient.MODE==EASY)?PACE_EASY:(TankClient.MODE==MEDIUM)?PACE_MIDIUM:(TankClient.MODE==HARD)?PACE_HARD:PACE_CRAZY;
	}
	...
	public void move() {
		...
		int PACE = (isMe)?PACE_MY:PACE_ENENMY;
		
		getDirection();
		switch(dir) {
		case U: ypos -= PACE; break;
		case D: ypos += PACE; break;
		case L: xpos -= PACE; break;
		case R: xpos += PACE; break;
		case UL: ypos -= PACE; xpos -= PACE; break;
		case UR: ypos -= PACE; xpos += PACE; break;
		case DL: ypos += PACE; xpos -= PACE; break;
		case DR: ypos += PACE; xpos += PACE; break;
		default: break;
		}
